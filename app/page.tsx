...
const products = [
  ...
  { name: 'Georadar', image: '/producto11.jpg' },
  { name: 'Tuberias de Perforacion', image: '/producto12.jpg' },
  { name: 'Sistema de potencia', image: '/producto13.jpg' },
